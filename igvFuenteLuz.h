...
class igvFuenteLuz {
    ...
    GLfloat posicion[4]; // posición de la luz
	...
	public:
		...
		// Metodos
		GLfloat* getPosicion(void); // devuelve la posición de la luz
		void setPosicion(GLfloat* pos); // establece la posición de la luz
